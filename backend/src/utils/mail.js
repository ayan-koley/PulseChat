...
const forgotPasswordMailgenContent = ({username, passwordResetUrl}) => {
    return {
        body: {
            name: username,
            intro: 'We received a request to reset the password for your Project Management account.',
            action: {
            ...
            outro: ["Need help or have question ? Just reply to this email, we'd love to help", "Best regards", "Project Management App Team"]
        }
    }
}
